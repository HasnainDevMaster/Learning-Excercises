...
let alien_color: string = "green"; // Declare a variable alien_color and assign it a value of 'green'
...
let alien_Color_fail: string = "yellow"; // Assigning an alien's color to 'yellow'
