// Using the Function: make_album that creates dictionaries representing music albums. It takes an artist name, an album title, and an optional parameter for the number of tracks:
function make_album(
  artist: string,
  title: string,
  tracks?: number
